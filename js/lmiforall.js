...
$.get(apicall, function(data) {
$("#Qualifications tbody").html("<td valign='top' align='center' width='auto' height='auto' style='background-color:#35b8b8; padding:5px 5px 5px 5px;'><font color='white'>Qualifications required</font></td>");
...
var apicall = apiurl + socCode;
$.get(apicall, function(data) {
$("#Task tbody").html("<td valign='top' align='center' width='auto' height='auto' style='background-color:#35b8b8; padding:5px 5px 5px 5px;'><font color='white'>Task</font></td>");
$.get(data.years, function (i, e) {
...
var apicall = apiurl + socCode;
$.get(apicall, function(data) {
$("#unemployment tbody").html("<td align='center' style='background-color:#35b8b8'><font color='white'>Unemployment Rate</font></td><td align='center' style='background-color:#35b8b8'><font color='white'>Year</font></td>");
...
$.get(apicall, function(data) {
$("#estimatedpay tbody").html("<td align='center' style='background-color:#35b8b8'><font color='white'>Estimated pay per week</font></td><td align='center' style='background-color:#35b8b8'><font color='white'>Year</font></td>");
...
var apicall = apiurl + socCode + apiurl2;
$.get(apicall, function(data) {
$("#estimatedhours tbody").html("<td align='center' style='background-color:#35b8b8'><font color='white'>Hours per week</font></td><td align='center' style='background-color:#35b8b8'><font color='white'>Year</font></td>");
$.each(data.series, function (i, e) {
