function getSOCsForJobTitle() {
	...
	$.get(apicall, function (data) {
		$("#socjobsearch tbody").html("<td align='center' style='background-color:#369fa8'><font color='white'>Job title</font></td><td align='center' style='background-color:#369fa8'><font color='white'>Company name</font></td>");
